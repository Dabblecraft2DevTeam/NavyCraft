...
public class NavyCraft_PlayerListener implements Listener {
	...
	public void onPlayerAnimation(PlayerAnimationEvent event) {
		if (event.getAnimationType() == PlayerAnimationType.ARM_SWING) {
			...
			if ((player.getItemInHand().getType() == Material.GOLD_PICKAXE) && NavyCraft.cleanupPlayers.contains(player.getName()) && PermissionInterface.CheckEnabledWorld(player.getLocation()) && !NavyCraft.checkSafeDockRegion(player.getLocation())) {
				Set<Material> transp = new HashSet<>();
				transp.add(Material.AIR);
				transp.add(Material.STATIONARY_WATER);
				transp.add(Material.WATER);
				...
				if (block != null) {
					System.out.println("Golden Pickaxe used:" + player.getName() + " X:" + block.getX() + " Y:" + block.getY() + " Z:" + block.getZ());
			...
			if (split.length >= 2) {
				if (split[1].equalsIgnoreCase("types")) {
					...
					if (PermissionInterface.CheckQuietPerm(player, "navycraft.admin")) {
						...
						player.sendMessage(ChatColor.BLUE + "/navycraft cleanup : " + ChatColor.WHITE + "enables cleanup tools, use lighter, gold pickaxe, and shears");
			...
			if (split.length > 1) {
				if (split[1].equalsIgnoreCase("load")) {
					...
					if (NavyCraft.playerSHIP1Signs.containsKey(UUID)) {
						for (Sign s : NavyCraft.playerSHIP1Signs.get(UUID)) {
					...
					if (NavyCraft.playerSHIP2Signs.containsKey(UUID)) {
						for (Sign s : NavyCraft.playerSHIP2Signs.get(UUID)) {
					...
					if (NavyCraft.playerSHIP3Signs.containsKey(UUID)) {
						for (Sign s : NavyCraft.playerSHIP3Signs.get(UUID)) {
					...
					if (NavyCraft.playerSHIP4Signs.containsKey(UUID)) {
						for (Sign s : NavyCraft.playerSHIP4Signs.get(UUID)) {
					...
					if (NavyCraft.playerSHIP5Signs.containsKey(UUID)) {
						for (Sign s : NavyCraft.playerSHIP5Signs.get(UUID)) {
					...
					if (NavyCraft.playerHANGAR1Signs.containsKey(UUID)) {
						for (Sign s : NavyCraft.playerHANGAR1Signs.get(UUID)) {
					...
					if (NavyCraft.playerHANGAR2Signs.containsKey(UUID)) {
						for (Sign s : NavyCraft.playerHANGAR2Signs.get(UUID)) {
					...
					if (NavyCraft.playerTANK1Signs.containsKey(UUID)) {
						for (Sign s : NavyCraft.playerTANK1Signs.get(UUID)) {
					...
					if (NavyCraft.playerTANK2Signs.containsKey(UUID)) {
						for (Sign s : NavyCraft.playerTANK2Signs.get(UUID)) {
					...
					if (NavyCraft.playerMAP1Signs.containsKey(UUID)) {
						for (Sign s : NavyCraft.playerMAP1Signs.get(UUID)) {
					...
					if (NavyCraft.playerMAP2Signs.containsKey(UUID)) {
						for (Sign s : NavyCraft.playerMAP2Signs.get(UUID)) {
					...
					if (NavyCraft.playerMAP3Signs.containsKey(UUID)) {
						for (Sign s : NavyCraft.playerMAP3Signs.get(UUID)) {
					...
					if (NavyCraft.playerMAP4Signs.containsKey(UUID)) {
						for (Sign s : NavyCraft.playerMAP4Signs.get(UUID)) {
					...
					if (NavyCraft.playerMAP5Signs.containsKey(UUID)) {
						for (Sign s : NavyCraft.playerMAP5Signs.get(UUID)) {
					...
					if (split.length == 3) {
						...
						if (UUID != null) {
							...
							if (NavyCraft.playerSHIP1Signs.containsKey(UUID)) {
								int numSHIP1s = NavyCraft.playerSHIP1Signs.get(UUID).size();
								if (NavyCraft.playerSHIP1Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "SHIP1 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + numSHIP1s + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerSHIP1Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								} else {
								...
								if (NavyCraft.playerSHIP1Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "SHIP1 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + "0" + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerSHIP1Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								}
							}
							if (NavyCraft.playerSHIP2Signs.containsKey(UUID)) {
								int numSHIP2s = NavyCraft.playerSHIP2Signs.get(UUID).size();
								if (NavyCraft.playerSHIP2Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "SHIP2 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + numSHIP2s + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerSHIP2Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								} else {
								...
								if (NavyCraft.playerSHIP2Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "SHIP2 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + "0" + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerSHIP2Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								}
							}
							if (NavyCraft.playerSHIP3Signs.containsKey(UUID)) {
								int numSHIP3s = NavyCraft.playerSHIP3Signs.get(UUID).size();
								if (NavyCraft.playerSHIP3Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "SHIP3 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + numSHIP3s + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerSHIP3Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								} else {
								...
								if (NavyCraft.playerSHIP3Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "SHIP3 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + "0" + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerSHIP3Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								}
							}
							if (NavyCraft.playerSHIP4Signs.containsKey(UUID)) {
								int numSHIP4s = NavyCraft.playerSHIP4Signs.get(UUID).size();
								if (NavyCraft.playerSHIP4Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "SHIP4 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + numSHIP4s + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerSHIP4Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								} else {
								...
								if (NavyCraft.playerSHIP4Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "SHIP4 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + "0" + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerSHIP4Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								}
							}
							if (NavyCraft.playerSHIP5Signs.containsKey(UUID)) {
								int numSHIP5s = NavyCraft.playerSHIP5Signs.get(UUID).size();
								if (NavyCraft.playerSHIP5Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "SHIP5 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + numSHIP5s + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerSHIP5Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								} else {
								...
								if (NavyCraft.playerSHIP5Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "SHIP5 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + "0" + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerSHIP5Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								}
							}
							if (NavyCraft.playerHANGAR1Signs.containsKey(UUID)) {
								int numHANGAR1s = NavyCraft.playerHANGAR1Signs.get(UUID).size();
								if (NavyCraft.playerHANGAR1Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "HANGAR1 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + numHANGAR1s + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerHANGAR1Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								} else {
								...
								if (NavyCraft.playerHANGAR1Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "HANGAR1 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + "0" + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerHANGAR1Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								}
							}
							if (NavyCraft.playerHANGAR2Signs.containsKey(UUID)) {
								int numHANGAR2s = NavyCraft.playerHANGAR2Signs.get(UUID).size();
								if (NavyCraft.playerHANGAR2Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "HANGAR2 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + numHANGAR2s + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerHANGAR2Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								} else {
...
>>>>>>> 6cc884c29f73ea56678e0b07cae99f38f2ab74b2
								if (NavyCraft.playerHANGAR2Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "HANGAR2 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + "0" + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerHANGAR2Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								}
							}
							if (NavyCraft.playerTANK1Signs.containsKey(UUID)) {
								int numTANK1s = NavyCraft.playerTANK1Signs.get(UUID).size();
								if (NavyCraft.playerTANK1Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "TANK1 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + numTANK1s + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerTANK1Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								} else {
								...
								if (NavyCraft.playerTANK1Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "TANK1 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + "0" + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerTANK1Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								}
							}
							if (NavyCraft.playerTANK2Signs.containsKey(UUID)) {
								int numTANK2s = NavyCraft.playerTANK2Signs.get(UUID).size();
								if (NavyCraft.playerTANK2Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "TANK2 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + numTANK2s + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerTANK2Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								} else {
								...
								if (NavyCraft.playerTANK2Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "TANK2 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + "0" + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerTANK2Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								}
							}
							if (NavyCraft.playerMAP1Signs.containsKey(UUID)) {
								int numMAP1s = NavyCraft.playerMAP1Signs.get(UUID).size();
								if (NavyCraft.playerMAP1Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "MAP1 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + numMAP1s + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerMAP1Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								} else {
								...
								if (NavyCraft.playerMAP1Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "MAP1 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + "0" + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerMAP1Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								}
							}
							if (NavyCraft.playerMAP2Signs.containsKey(UUID)) {
								int numMAP2s = NavyCraft.playerMAP2Signs.get(UUID).size();
								if (NavyCraft.playerMAP2Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "MAP2 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + numMAP2s + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerMAP2Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								} else {
								...
								if (NavyCraft.playerMAP2Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "MAP2 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + "0" + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerMAP2Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								}
							}
							if (NavyCraft.playerMAP3Signs.containsKey(UUID)) {
								int numMAP3s = NavyCraft.playerMAP3Signs.get(UUID).size();
								if (NavyCraft.playerMAP3Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "MAP3 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + numMAP3s + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerMAP3Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								} else {
								...
								if (NavyCraft.playerMAP3Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "MAP3 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + "0" + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerMAP3Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								}
							}
							if (NavyCraft.playerMAP4Signs.containsKey(UUID)) {
								int numMAP4s = NavyCraft.playerMAP4Signs.get(UUID).size();
								if (NavyCraft.playerMAP4Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "MAP4 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + numMAP4s + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerMAP4Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								} else {
								...
								if (NavyCraft.playerMAP4Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "MAP4 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + "0" + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerMAP4Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								}
							}
							if (NavyCraft.playerMAP5Signs.containsKey(UUID)) {
								int numMAP5s = NavyCraft.playerMAP5Signs.get(UUID).size();
								if (NavyCraft.playerMAP5Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "MAP5 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + numMAP5s + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerMAP5Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								} else {
								...
								if (NavyCraft.playerMAP5Rewards.containsKey(UUID)) {
									player.sendMessage(ChatColor.GOLD + "MAP5 " + ChatColor.DARK_GRAY + "[" + ChatColor.GREEN + "0" + ChatColor.DARK_GRAY + "]" + ChatColor.GRAY + "/" + ChatColor.DARK_GRAY + "[" + ChatColor.RED + NavyCraft.playerMAP5Rewards.get(UUID) + ChatColor.DARK_GRAY + "]" + ChatColor.DARK_AQUA + " available");
								}
							}
						} else {
