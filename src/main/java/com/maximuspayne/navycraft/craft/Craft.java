 ...
 *
 * You are free to modify it for your own server or use part of the code for
 * your own MoveCraft. You don't need to credit me if you do, but I would
 * appreciate it :)
 *
 * You are not allowed to distribute alternative versions of MoveCraft without
...
public class Craft {
	...
	// public static HashMap<Player, Integer> playerClipboardsCost = new
	...
	public HashMap<Integer, Integer> tubeFiringMode = new HashMap<Integer, Integer>(); ///// tubeNumber,
																						///// tubeStatus...status = -2
																						///// straight, -1 periscope, 0+
																						///// for target index
	...
	public Craft(CraftType type, Player player, String customName, float Rotation, Location signBlockLoc, Plugin p) {
		...
		signLoc = signBlockLoc;
		plugin = p;

		craftID = craftIDTicker;
		craftIDTicker++;
	}
	...
	public void addBlock(Block block, boolean overrideAdd) {
		...
		if ((x < sizeX) && (x >= 0) && (y < sizeY) && (y >= 0) && (z < sizeZ) && (z >= 0)) {
			if (overrideAdd || (((x < (sizeX - 1)) && !isFree(matrix[x + 1][y][z])) || ((x > 0) && !isFree(matrix[x - 1][y][z])) || ((y < (sizeY - 1)) && !isFree(matrix[x][y + 1][z])) || ((y > 0) && !isFree(matrix[x][y - 1][z])) || ((z < (sizeZ - 1)) && !isFree(matrix[x][y][z + 1])) || ((z > 0) && !isFree(matrix[x][y][z - 1])))) {
	...
	private boolean canGoThrough(int craftBlockId, int blockId, int data) {
		...
		if ((blockId == 0) || ((blockId >= 8) && (blockId <= 11)) || (blockId == 78) || BlocksInfo.coversGrass(blockId)) {
			return true;
		}
	...
	public boolean canMove(int dx, int dy, int dz) {
		...
		if (type.canFly && type.doesCruise) {
			if (!onGround) {
				if ((speed >= 10) && (dy != 0)) {
					dy = ((speed - 6) / 2) * (int) Math.signum(dy);
				} else if ((speed >= 8) && (dy != 0)) {
					dy = (int) Math.signum(dy);
				} else if ((speed >= 8) && (dy == 0)) {
					dy = 0;
				} else if (speed > 5) {
	...
	public void buildCrew(Player newCaptain, boolean addOnly) {
		...
		for (Entity e : ents) {
			if (e instanceof Player) {
				...
				if ((p != newCaptain) || type.canFly || type.isTerrestrial) {
					if (type.canFly) {
		...
		captainName = newCaptain.getName();
		if (!crewNames.contains(captainName)) {
			crewNames.add(captainName);
			isNameOnBoard.put(captainName, true);
		}
		// captain inventory
		if (!type.canFly && !type.isTerrestrial) {
			Player captain = plugin.getServer().getPlayer(captainName);
		...
		if (customName == null) {
			for (String s : crewNames) {
				...
				if ((p != null) && (s != captainName)) {
					p.sendMessage(ChatColor.GOLD + "You join the crew of the " + ChatColor.WHITE + name.toUpperCase() + ChatColor.GOLD + " class under the command of " + newCaptain.getDisplayName() + "!");
			...
			for (String s : crewNames) {
				Player p = NavyCraft.instance.getServer().getPlayer(s);
				if ((p != null) && (s != captainName)) {
					p.sendMessage(ChatColor.GOLD + "You join the " + ChatColor.WHITE + name.toUpperCase() + ChatColor.YELLOW + " under the command of " + newCaptain.getDisplayName() + "!");
					newCaptain.sendMessage(p.getDisplayName() + ChatColor.GOLD + " joins your crew!");
				}
			}
		}
				...
				try {
					...
					for (Entity e : ents) {
						if (!(e instanceof Item) && this.isOnCraft(e, false)) {
							checkEntities.add(e);
						} else if ((e instanceof Item) && (sinking || removeItems) && this.isOnCraft(e, false)) {
							e.remove();
						}
					}
				} catch (Exception ex) {
	...
	public int[] enginesByEngineFace(CraftMover cm) {
		...
		for (DataBlock edb : engineBlocks) {
			// Block engineBlock = world.getBlockAt(this.minX + edb.x, this.minY + edb.y,
			// this.minZ + edb.z);
	...
	public Location getLocation() {
		return new Location(world, minX + (sizeX / 2), minY + (sizeY / 2), minZ + (sizeZ / 2));
	}
	...
	// block resistance to breaking/damage....0=default(glass), 1=wood, 2=iron, 3=
	// obsidian bedrock
	public static int blockHardness(int blockID) {
		if ((blockID == 7) || (blockID == 120) || (blockID == 130) || (blockID == 137)) {
			...
			return -3;
		} else if ((blockID == 1) || (blockID == 4) || (blockID == 23) || (blockID == 41) || (blockID == 251) || (blockID == 42) || (blockID == 48) || (blockID == 57) || (blockID == 67) || (blockID == 71) || (blockID == 86) || (blockID == 98) || (blockID == 109) || (blockID == 112) || (blockID == 114) || (blockID == 121) || (blockID == 122) || (blockID == 133) || (blockID == 139) || (blockID == 155) || (blockID == 156) || (blockID == 251) || ((blockID >= 235) && (blockID <= 250))) {
			return 2;
		} else if ((blockID == 2) || (blockID == 3) || (blockID == 5) || (blockID == 12) || (blockID == 13) || (blockID == 14) || (blockID == 15) || (blockID == 16) || (blockID == 17) || (blockID == 19) || (blockID == 20) || (blockID == 95) || (blockID == 21) || (blockID == 22) || (blockID == 24) || (blockID == 25) || (blockID == 29) || (blockID == 33) || (blockID == 35) || (blockID == 43) || (blockID == 44) || (blockID == 45) || (blockID == 47) || (blockID == 53) || (blockID == 54) || (blockID == 56) || (blockID == 58) || (blockID == 60) || (blockID == 61) || (blockID == 62) || (blockID == 63) || (blockID == 64) || (blockID == 65) || (blockID == 68) || (blockID == 69) || (blockID == 70) || (blockID == 72) || (blockID == 73) || (blockID == 74) || (blockID == 77) || (blockID == 78) || (blockID == 79) || (blockID == 80) || (blockID == 82) || (blockID == 84) || (blockID == 85) || (blockID == 91) || (blockID == 96) || (blockID == 101) || (blockID == 107) || (blockID == 108) || (blockID == 110) || (blockID == 113) || (blockID == 117) || (blockID == 118) || (blockID == 125) || (blockID == 126) || (blockID == 128) || (blockID == 159) || (blockID == 172) || (blockID == 134) || (blockID == 135) || (blockID == 136) || (blockID == 138) || (blockID == 143) || (blockID == 146) || (blockID == 147) || (blockID == 148) || (blockID == 154) || (blockID == 158)) {
			return 1;
	...
	public static float blockWeight(int blockID) {
		if ((blockID == 7) || (blockID == 49) || (blockID == 130)) {
			return 20.0f;
		} else if ((blockID == 1) || (blockID == 2) || (blockID == 3) || (blockID == 4) || (blockID == 12) || (blockID == 13) || (blockID == 22) || (blockID == 23) || (blockID == 24) || (blockID == 29) || (blockID == 33) || (blockID == 41) || (blockID == 42) || (blockID == 45) || (blockID == 46) || (blockID == 48) || (blockID == 57) || (blockID == 60) || (blockID == 61) || (blockID == 62) || (blockID == 67) || (blockID == 71) || (blockID == 78) || (blockID == 79) || (blockID == 80) || (blockID == 82) || (blockID == 86) || (blockID == 98) || (blockID == 108) || (blockID == 109) || (blockID == 110) || (blockID == 112) || (blockID == 114) || (blockID == 116) || (blockID == 120) || (blockID == 121) || (blockID == 128) || (blockID == 129) || (blockID == 133) || (blockID == 138) || (blockID == 139) || (blockID == 145) || (blockID == 152) || (blockID == 154) || (blockID == 155) || (blockID == 156) || (blockID == 158) || (blockID == 251) || ((blockID >= 235) && (blockID <= 250))) {
			return 1.0f;
		} else if ((blockID == 19) || (blockID == 43) || (blockID == 54) || (blockID == 58) || (blockID == 64) || (blockID == 91) || (blockID == 96) || (blockID == 101) || (blockID == 113) || (blockID == 117) || (blockID == 118) || (blockID == 137) || (blockID == 153) || (blockID == 170) || (blockID == 173) || (blockID == 172)) {
			return 0.5f;
		} else if ((blockID == 5) || (blockID == 14) || (blockID == 15) || (blockID == 16) || (blockID == 17) || (blockID == 21) || (blockID == 25) || (blockID == 44) || (blockID == 47) || (blockID == 53) || (blockID == 56) || (blockID == 63) || (blockID == 65) || (blockID == 68) || (blockID == 73) || (blockID == 74) || (blockID == 159) || (blockID == 84) || (blockID == 125) || (blockID == 126) || (blockID == 134) || (blockID == 135) || (blockID == 136)) {
			return 0.25f;
	...
	public static Block getAttachedBlock(Block inBlock, int blockID, int data) {
		...
		} else if ((blockID == 70) || (blockID == 72) || (blockID == 55) || (blockID == 64) || (blockID == 71)) // pressure
																												// plates
																												// and
																												// wire
																												// and
	...
	public void speedChange(Player player, boolean increase) {
		...
		if (increase) {
			if (!type.canFly) {
				setSpeed = setSpeed + 1;
				if (setSpeed > type.maxEngineSpeed) {
					setSpeed = type.maxEngineSpeed;
				}
				if (setSpeed == 1) {
					if (player != null) {
			...
			if (!type.canFly) {
				setSpeed = setSpeed - 1;
				if (setSpeed <= 0) {
					if (NavyCraft.checkSpawnRegion(new Location(world, minX, minY, minZ)) || NavyCraft.checkSpawnRegion(new Location(world, maxX, maxY, maxZ))) {
						if (player != null) {
		...
		if (player != null) {
			if (type.canFly) {
				player.sendMessage(ChatColor.GOLD + "Throttle-" + ChatColor.GREEN + (setSpeed * 10) + ChatColor.GOLD + "%");
			} else if (type.isTerrestrial) {
				player.sendMessage(ChatColor.GOLD + "Throttle-" + ChatColor.GREEN + (setSpeed * 25) + ChatColor.GOLD + "%");
			} else {
				if (setSpeed == 0) {
	...
	public void gearChange(Player player, boolean increase) {
		...
		if (increase) {
			if (!type.canFly) {
				...
				if (gear > type.maxForwardGear) {
					gear = type.maxForwardGear;
				}
				if (gear == 1) {
		...
		} else /// decrease
		{
			if (!type.canFly) {
				...
				} else if (gear <= type.maxReverseGear) {
					gear = type.maxReverseGear;
				}
			} else {
				gear = gear - 1;
				if (gear == 0) {
		...
		if (player != null) {
			player.sendMessage(ChatColor.GOLD + "Set engines to Gear" + ChatColor.DARK_GRAY + " - " + ChatColor.GREEN + gear + ChatColor.DARK_GRAY + "/" + ChatColor.RED + type.maxForwardGear);
		}
	}
	...
	public void rudderChange(Player player, int order, boolean turn) {
		...
		if (type.canFly && (gear > 1) && onGround) {
			if (player != null) {
		...
		if (order == 1) {
			if ((rudder == 0) || ((rudder == 1) && turn && (turnProgress == 0))) {
				rudder = 1;
				if (turn) {
					turnProgress = type.turnRadius;
					if (player != null) {
				...
				if ((turnProgress == 0) || (turnProgress > (type.turnRadius / 2))) {
					rudder = 0;
					turnProgress = 0;
					if (player != null) {
